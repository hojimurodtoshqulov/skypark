...
const Prices = ({ handleClick }) => {
	...
	return (
		<div className={`${scss.prices} container`}>
			<div className={scss.pricesTitle}>
				<span
					className={scss.pricesTitle_arrow}
					onClick={() => {
						select === 0
							? setSelect(tLength - 1)
			...
			{arr[select]?.map((item, index) => (
				...
				>
					<div className={scss.pricesElements}>
						<div className={scss.pricesElementsCol1}>
							<motion.div
								className={scss.pricesElementsCol1Ele}
								key={select}
								initial={{ opacity: 0, y: 100 }}
								animate={{ opacity: 1, y: 0 }}
								exit={{ opacity: 0, y: -100 }}
						...
						<div className={scss.pricesElementsCol2}>
							<motion.div
								className={scss.pricesElementsCol2Ele}
								key={select}
								initial={{ opacity: 0, y: 100 }}
								animate={{ opacity: 1, y: 0 }}
								exit={{ opacity: 0, y: -100 }}
							...
							<span className={scss.pricesElementsCol2Buy}>
								{t("home.month.sell")}
							</span>
						</div>
					</div>
